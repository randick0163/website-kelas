...
const Schedule = () => {
  ...
  if (currentWeek === 2 || currentWeek === 4) {
    piketGroup = [
      ["Dini", "Rifa", "Indah", "Mamal", "Nida", "Zamzam"],
      ["Cica", "Ratnasari", "Arman", "Fajri"],
      ["Alma", "Azahra", "Yogi", "Aan", "Iman", "Adrian"],
      ["Nia", "Siti", "Aldiansyah", "Rega", "Randi", "Rifki"],
      ["Indriani", "Ulfi", "Zaki", "Rizki", "Intan"],
      ["Sindi", "Maskia", "Meyra", "Haikal", "Cecep"],
    ];
